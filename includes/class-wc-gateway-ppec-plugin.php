...
class WC_Gateway_PPEC_Plugin {
	...
	public function bootstrap() {
		try {
			if ( $this->_bootstrapped ) {
				throw new Exception( __( 'WooCommerce Gateway PayPal Checkout plugin can only be called once', 'woocommerce-gateway-paypal-express-checkout' ), self::ALREADY_BOOTSTRAPED );
			}
	...
	public function show_spb_notice() {
		...
		// Translators: placeholder is the URL for the plugin's settings screen.
