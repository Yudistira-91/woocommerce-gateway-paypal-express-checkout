...
class PayPal_API_Error {
	...
	public function mapToBuyerFriendlyError() { // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.MethodNameInvalid
		switch ( $this->error_code ) {
			...
			default:      return /* Translators: placeholder is an error code. */ sprintf( __( 'An error (%s) occurred while processing your PayPal payment.  Please contact the store owner for assistance.', 'woocommerce-gateway-paypal-express-checkout' ), $this->error_code );
		}
	}
}
